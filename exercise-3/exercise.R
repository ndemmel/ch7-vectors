...
words <- c("programming", "koala", "town", "shiny", "cool", "onomatopoeia")
...
words_of_the_day <- paste0("'", words, "' is the words of the day!'")
words_of_the_day
...
word_bin <- function(words, first_letter, last_letter) {
  words[words >= first_letter & substring(words, 1, 1) <= last_letter]
}
